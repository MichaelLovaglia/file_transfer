...
///	LoadStdProfileSettings();  // Load standard INI file options (including MRU)
	...
	CString tINI = sModulePath + "\\FileTransferClient.ini";
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CFileTransferClientDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CFileTransferClientView));
...
void CFileTransferClientApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
/////////////////////////////////////////////////////////////////////////////
// CFileTransferClientApp message handlers
